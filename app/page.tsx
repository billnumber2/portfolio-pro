...
const STORAGE_KEY = "portfolio-pro-v7-dashboard-holdings-grouped";
...
export default function Page() {
  ...
  const holdingsSummary = useMemo(() => {
    ...
    const totalValue = groupedList.reduce((sum, item) => sum + Number(item.valueTwd || 0), 0);
    return groupedList
      .map((item) => ({
        ...item,
        weight: totalValue > 0 ? (Number(item.valueTwd || 0) / totalValue) * 100 : 0,
      }))
