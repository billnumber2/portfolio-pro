...
const STORAGE_KEY = "portfolio-pro-v6-daily-snapshots";
  ...
  return (
    <main className="min-h-screen p-4 md:p-8 bg-slate-50">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {tab === "dashboard" && <Dashboard totals={totals} monthlyReport={monthlyReport} allocation={allocation} fxRate={fxRate} setFxRate={setFxRate} snapshotChartData={snapshotChartData} snapshotsLoading={snapshotsLoading} />}
...
function Dashboard({ totals, monthlyReport, allocation, fxRate, setFxRate, snapshotChartData, snapshotsLoading }: any) {
